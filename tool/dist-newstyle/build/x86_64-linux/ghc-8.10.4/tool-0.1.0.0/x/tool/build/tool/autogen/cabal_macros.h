...
/* package tool-0.1.0.0 */
#ifndef VERSION_tool
#define VERSION_tool "0.1.0.0"
#endif /* VERSION_tool */
#ifndef MIN_VERSION_tool
#define MIN_VERSION_tool(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_tool */
...
#define CURRENT_COMPONENT_ID "tool-0.1.0.0-inplace-tool"
